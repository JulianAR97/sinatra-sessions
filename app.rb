...
class App < Sinatra::Base
  ...
  get '/' do
    'Welcome to Sinatra Sessions! In this lab, we will be learning about the general principles'\
    " behind a sessions cookie. In order to proceed, let's go to the '/first_exercise' path."
  end

  get '/first_exercise' do
    "Your first exercise will be to set your session key-value pair.\n"\
    "In the route: get '/set', write a line of code that sets the :foo key\n"\
    "of the session hash equal to 'hello'. Then, navigate to the '/set' path."
  end
